...
class ClientesModel extends Mysql
{
	...
	public function selectCliente(int $idpersona)
	{
		...
		{
			$sql = "SELECT idpersona,identificacion,nombres,apellidos,telefono,email_user,nit,nombrefiscal,direccionfiscal,DATE_FORMAT(datecreated, '%d-%m-%Y') as fechaRegistro FROM persona WHERE idpersona = $this->intIdUsuario  AND rolid = 7 " ;
