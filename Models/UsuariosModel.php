<?php 
	...
	class UsuariosModel extends Mysql
	{
		...
		public function selectUsuarios()
		{
			...
			$sql = "SELECT p.idpersona, p.identificacion, p.nombres, p.apellidos, p.telefono, p.email_user, p.rolid, p.status, r.idrol, r.nombrerol 
					FROM persona p
					INNER JOIN rol r 
					ON p.rolid = r.idrol 
		...
		public function selectUsuario(int $idpersona)
		{
			...
			$sql = "SELECT p.idpersona, p.identificacion, p.nombres, p.apellidos, p.telefono, p.email_user, p.nit, p.nombrefiscal, p.direccionfiscal, p.rolid, r.nombrerol, p.status, DATE_FORMAT(p.datecreated, '%d-%m-%Y') as fechaRegistro
					FROM persona p
					INNER JOIN rol r
					ON  p.rolid = r.idrol
