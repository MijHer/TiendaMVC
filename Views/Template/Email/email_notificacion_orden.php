			...
			<tr>
				...
				<td width="33.33%">
					<div class="text-center">
						<h5><strong>SISTEMA VENTAS</strong></h5>
						<p>
							<?= DIRECCION ?> <br>
				...
				<td width="33.33%">
					<div class="text-right">
						<p>
							...
							Fecha: <strong><?= date('d-m-Y', strtotime($orden['fecha'])) ?></strong>  <br>
							Hora: <strong><?= date('H:i', strtotime($orden['fecha'])) ?></strong>  <br>
							Método Pago: <strong><?= $orden['tipopago'] ?> <br></strong>
							<?php 
								if ($orden['idtransaccionpaypal'] == "") {
									 
								}else{
									  echo "Transacción:"." ".$orden['idtransaccionpaypal'];
								}
							 ?> 
						</p>
					</div>
