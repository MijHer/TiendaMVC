		...
		<tbody>
			...
			<tr>
				<td>
					...
					<p>Bienvenido a nuestro tienda en linea</p>
					<p>Ahora puedes realizar tus compras en linea sin salir de casa </p>
					<p>Accede a tu cuenta con tus credenciales: </p>
					<p>Usuario: <span><?= $data['email']; ?></span> </p>
					<p>Contraseña: <span><?= $data['password']; ?></span> </p>
					<a href="<?= BASE_URL; ?>" target="_blanck" class="x_button x_link_red">Compra ahora</a>
