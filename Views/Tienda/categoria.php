	...
	<div class="bg0 m-t-23 p-b-140">
		<div class="container">
			...
			<div class="row isotope-grid">
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							...
							<div class="block2-txt-child2 flex-r p-t-3">
								<a id="<?= openssl_encrypt($arrProductos[$p]['idproducto'], METHODENCRIPT, KEY) ?>" href="<?= base_url().'/tienda/producto/'.$arrProductos[$p]['nombre']?>" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2 icon-header-item cl2 hov-cl1 trans-04 p-r-11 js-addcart-detail">
				...
				?>
					<p>No hay productos para mostrar <a href="<?= base_url() ?>/tienda"> Ver Tienda</a></p>
				<?php 
					} 
				?>
			...
			<div class="flex-c-m flex-w w-full p-t-45">
				<?php 
					if ($data['pagina'] > 1) {
				?>
				<a href="<?= base_url() ?>/tienda/categoria/<?= $data['infoCategoria']['idcategoria']."/". $data['infoCategoria']['ruta']."/".$prevPagina ?>" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04"><i class="fa fa-chevron-left"></i> &nbsp; Anterior</a> &nbsp;
				<?php } ?>
