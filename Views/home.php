				...
				<div class="item-slick1" style="background-image: url(<?= $arrSlider[$i]['portada'] ?>);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							...
							<!-- aqui se modificao la ruta con str_replace -> str_replace(' ', '_', $arrSlider[$i]['nombre']); para elminar las rutas con espacio -->
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							...
							<div class="block2-txt-child2 flex-r p-t-3">
								<a href="#" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2 icon-header-item cl2 hov-cl1 trans-04 p-r-11 js-addcart-detail" id="<?= openssl_encrypt($arrProductos[$p]['idproducto'], METHODENCRIPT, KEY) ?>">
